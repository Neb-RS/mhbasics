...
This is typically the first point that a player finds difficulty in meeting the gold target. You may read Early Rank [Gold Guide](https://mhcommunity.github.io/mhbasics/docs/NtGM/goldfarming) for more gold farming suggestions.
...
Travel to S.S. Huntington IV when you rank up to [Legendary](https://mhcommunity.github.io/mhbasics/docs/LtK/8. Legendary).